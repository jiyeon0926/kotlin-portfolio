...
import com.jiyeon.portfolio.admin.context.experience.form.ExperienceForm
...
class AdminExperienceApiController(
    ...
    @PutMapping("/{id}")
    fun putExperience(@PathVariable id: Long,
                      @RequestBody form: ExperienceForm): ResponseEntity<Any> {
